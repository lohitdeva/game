...
function displayAverage() {
    ...
    for (let i = 0; i < scoreHistory.length; i++) {
        sum = sum + scoreHistory[i];
    }
    var average = sum / scoreHistory.length;
    averageScore.textContent = `Your average score is ${average}ms`;
    document.cookie = "reactionTimeScore = " + Math.round(average);
}
